...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendNotification(View view)
    {
        ...
        {
            NotificationChannel nc = new NotificationChannel("srminterns","SRM NOTIFICATION", NotificationManager.IMPORTANCE_HIGH);
        ...
        builder.setContentTitle("Deepika Notification");
        builder.setContentText("This is the description of the notification.:Narne Deepika");
